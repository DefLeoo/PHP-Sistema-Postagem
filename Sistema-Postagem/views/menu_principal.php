  ...
  <div class="container-fluid navbar_menu container-menu-principal">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <div class="col-xs-2 col-md-1 ">
         ...
         <img src="../public/img/c.jpg" class="img-circle" alt="User">
         </a>
      </div>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown navbar_dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="../admin/site.php"><span class="glyphicon glyphicon-picture" aria-hidden="true"></span> Visualizar</a></li>
